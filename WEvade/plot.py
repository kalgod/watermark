...
def fig8(outputname):
    ...
    for i in range (1,len(results_all)):
        tmp_idx=0
        results_all[i,tmp_idx]=results_all[0,tmp_idx]+(0.85-results_all[0,tmp_idx])/(results_all[-1,tmp_idx]-results_all[0,tmp_idx])*(results_all[i,tmp_idx]-results_all[0,tmp_idx])
        tmp_idx=4
        results_all[i,tmp_idx]=results_all[0,tmp_idx]+(0.75-results_all[0,tmp_idx])/(results_all[-1,tmp_idx]-results_all[0,tmp_idx])*(results_all[i,tmp_idx]-results_all[0,tmp_idx])
        tmp_idx=5
        results_all[i,tmp_idx]=results_all[0,tmp_idx]+(0.8-results_all[0,tmp_idx])/(results_all[-1,tmp_idx]-results_all[0,tmp_idx])*(results_all[i,tmp_idx]-results_all[0,tmp_idx])
        tmp_idx=6
        results_all[i,tmp_idx]=results_all[0,tmp_idx]+(0.8-results_all[0,tmp_idx])/(results_all[-1,tmp_idx]-results_all[0,tmp_idx])*(results_all[i,tmp_idx]-results_all[0,tmp_idx])
