...
def run_tree_ring(x0,pipe):
    parser = argparse.ArgumentParser(description='diffusion watermark')
    parser.add_argument('--run_name', default='test')
    parser.add_argument('--dataset', default='Gustavosta/Stable-Diffusion-Prompts')
    parser.add_argument('--start', default=0, type=int)
    parser.add_argument('--end', default=10, type=int)
    parser.add_argument('--image_length', default=x0.shape[-1], type=int)
    parser.add_argument('--model_id', default='stabilityai/stable-diffusion-2-1-base')
    parser.add_argument('--with_tracking', action='store_true')
    parser.add_argument('--num_images', default=x0.shape[0], type=int)
    ...
    seed = args.gen_seed
    current_prompt = 'a man on a horse'
    ...
    # init_latents_no_w=image_latents_no_w #test
    ...
    # print(img_no_w.shape,image_latents_no_w.shape,init_latents_no_w.shape,orig_image_no_w.shape,init_latents_w.shape,gt_patch.shape)
    ...
    orig_image_w = outputs_w
    print(img_no_w,"\n",image_latents_no_w,"\n",init_latents_no_w,"\n",orig_image_no_w,"\n",init_latents_w,"\n",outputs_w)
    return 2*orig_image_no_w-1




def decode_tree_ring(xr,pipe):
    parser = argparse.ArgumentParser(description='diffusion watermark')
    parser.add_argument('--run_name', default='test')
    parser.add_argument('--dataset', default='Gustavosta/Stable-Diffusion-Prompts')
    parser.add_argument('--start', default=0, type=int)
